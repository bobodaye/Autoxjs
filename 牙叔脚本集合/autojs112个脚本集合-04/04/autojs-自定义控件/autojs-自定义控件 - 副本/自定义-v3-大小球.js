...
(function () {
  ...
  function CustomView() {
    ...
    let tipHeight = 50;
    let tipWidth = 50;
    let bgColor = colors.parseColor("#ff00ff00");
  ...
  CustomView.prototype.render = function () {
    return (
      <HorizontalScrollView padding="1 1 1 1" h="60dp" w="300dp" gravity="center_vertical" scrollbars="none">
        <LinearLayout gravity="center_vertical">
